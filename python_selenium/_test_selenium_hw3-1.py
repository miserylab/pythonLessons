...
class ProductLocators:
    ...
    def __init__(self, name, name_locator, price_locator, button_locator):
        self.name = name
...
try:
    ...
    if сhosen_product_number <= len(products):
        product_name = products[сhosen_product_number - 1].name
...
value_product = driver.find_element(By.XPATH, products[сhosen_product_number - 1].name_locator).text
print(value_product)

value_price_product = driver.find_element(By.XPATH, products[сhosen_product_number - 1].price_locator).text
print(value_price_product)

select_product = driver.find_element(By.XPATH, products[сhosen_product_number - 1].button_locator)
select_product.click()

print(f"Product {value_product} added to cart!")
