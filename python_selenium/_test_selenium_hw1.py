...
sum_from_products = float(value_price_product_1.replace('$','')) + float(value_price_product_2.replace('$',''))
print(sum_from_products)

summary_price = driver.find_element(By.XPATH, "//div[@class='summary_subtotal_label']")
value_summary_price = summary_price.text
print(value_summary_price)

item_total = "Item total: $" + str(sum_from_products)
print(item_total)
